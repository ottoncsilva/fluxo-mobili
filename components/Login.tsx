        ...
        <div className="hidden md:flex flex-1 relative bg-gradient-to-br from-primary to-blue-700 items-center justify-center p-12 text-white">
            ...
            <div className="relative z-10 max-w-sm">
                ...
                <h2 className="text-4xl font-extrabold mb-4 leading-tight">
                    Gerencie sua produção com maestria.
                </h2>
        ...
        <div className="flex-1 p-8 md:p-12 flex flex-col justify-center transition-all">
            ...
            <div className="mt-8 text-center animate-fade-in space-y-4">
                <p className="text-xs text-slate-400 dark:text-slate-500">
                    ...
                    Loja: <span className="font-mono text-slate-600 dark:text-slate-300">modelo</span><br/>
                    Usuário: <span className="font-mono text-slate-600 dark:text-slate-300">ottonsilva</span><br/>
                    Senha: <span className="font-mono text-slate-600 dark:text-slate-300">123456</span>
                </p>
                <p className="text-xs text-slate-400 dark:text-slate-500 border-t border-slate-200 dark:border-slate-800 pt-2">
                    Acesso Gestor (Admin Global):<br/>
                    Loja: <span className="font-mono text-purple-600 dark:text-purple-400 font-bold">admin</span><br/>
                    Usuário: <span className="font-mono text-purple-600 dark:text-purple-400 font-bold">admin</span><br/>
                    Senha: <span className="font-mono text-purple-600 dark:text-purple-400 font-bold">Dell@7567</span>
                </p>
            </div>
        </div>
      </div>
